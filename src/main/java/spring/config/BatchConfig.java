...
public class BatchConfig {
    ...
    public BatchConfig(JobBuilderFactory jobBuilderFactory, StepBuilderFactory stepBuilderFactory, DataSource dataSource, MongoTemplate mongoTemplate) {
    ...
    @Bean
    public Job migrateMongoToPostgres() {
        return jobBuilderFactory.get("migrateMongoToPostgres")
                .start(bookStep())
                .next(genreStep())
                .next(authorStep())
                .next(commentStep())
